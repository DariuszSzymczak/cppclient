...
"}\n"
""));
        verticalLayoutWidget = new QWidget(userRegister);
        ...
        userLogin = new QLineEdit(verticalLayoutWidget);
        userLogin->setObjectName(QStringLiteral("userLogin"));

        horizontalLayout->addWidget(userLogin);
        ...
        horizontalLayout_2->addWidget(userPassword);
    ...
    {
        userRegister->setWindowTitle(QApplication::translate("userRegister", "Zarejestruj si\304\231", nullptr));
        label->setText(QApplication::translate("userRegister", "Login: ", nullptr));
        label_2->setText(QApplication::translate("userRegister", "Has\305\202o: ", nullptr));
        pushButton->setText(QApplication::translate("userRegister", "Zarejestruj", nullptr));
        pushButton_2->setText(QApplication::translate("userRegister", "Zamknij", nullptr));
    } // retranslateUi
