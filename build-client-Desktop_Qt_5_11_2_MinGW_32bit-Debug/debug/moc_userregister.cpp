...
QT_MOC_LITERAL(4, 51, 21) // "on_pushButton_clicked"
    ...
    "userRegister\0registerUser\0\0"
...
void userRegister::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->registerUser((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (userRegister::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&userRegister::registerUser)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject userRegister::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_userRegister.data,
      qt_meta_data_userRegister,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void userRegister::registerUser(QString _t1)
{
