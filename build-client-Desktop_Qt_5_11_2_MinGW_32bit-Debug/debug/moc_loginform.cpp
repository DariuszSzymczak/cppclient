...
QT_MOC_LITERAL(1, 10, 9), // "loginUser"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 22), // "on_closeButton_clicked"
QT_MOC_LITERAL(4, 44, 22) // "on_loginButton_clicked"

    },
    "LoginForm\0loginUser\0\0on_closeButton_clicked\0"
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginUser((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginForm::loginUser)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginForm::loginUser(QString _t1)
{
